...
static int dump_entry(struct ipt_entry *e, struct xtc_handle *const handle) {
    size_t i;
...
static unsigned char *is_same(const STRUCT_ENTRY *a, const STRUCT_ENTRY *b,
    ...
    if (a->ip.src.s_addr != b->ip.src.s_addr ||
        ...
        a->ip.dmsk.s_addr != b->ip.dmsk.s_addr || a->ip.proto != b->ip.proto ||
