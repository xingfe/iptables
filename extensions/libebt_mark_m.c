...
static const struct option brmark_m_opts[] = {
    {.name = "mark", .has_arg = true, .val = MARK}, XT_GETOPT_TABLEEND,
};
...
static int brmark_m_parse(int c, char **argv, int invert, unsigned int *flags,
...
void _init(void) { xtables_register_match(&brmark_m_match); }
