...
static int br802_3_parse(int c, char **argv, int invert, unsigned int *flags,
...
static void br802_3_final_check(unsigned int flags) {
    if (!flags)
...
void _init(void) { xtables_register_match(&br802_3_match); }
