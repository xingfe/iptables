...
static void socket_mt_save_v2(const void *ip,
...
static void socket_mt_print_v2(const void *ip,
                               const struct xt_entry_match *match,
                               int numeric) {
    printf(" socket");
...
static void socket_mt_save_v3(const void *ip,
                              const struct xt_entry_match *match) {
...
static void socket_mt_print_v3(const void *ip,
                               const struct xt_entry_match *match,
                               int numeric) {
    printf(" socket");
