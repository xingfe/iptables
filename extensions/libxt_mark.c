...
static void mark_mt_print(const void *ip, const struct xt_entry_match *match,
                          int numeric) {
...
static void mark_print(const void *ip, const struct xt_entry_match *match,
                       int numeric) {
...
static void print_mark_xlate(struct xt_xlate *xl, unsigned int mark,
