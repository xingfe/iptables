...
static struct ipt_natinfo *append_range(struct ipt_natinfo *info,
...
static struct xt_entry_target *parse_to(const char *orig_arg, int portok,
...
void _init(void) { xtables_register_target(&dnat_tg_reg); }
