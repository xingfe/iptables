...
static int do_output(struct nft_handle *h, const char *tablename,
                     bool counters) {
    ...
    printf("# Generated by xtables-save v%s on %s", IPTABLES_VERSION,
           ctime(&now));
    printf("*%s\n", tablename);
 ...
 * rule
 */
static int xtables_save_main(int family, const char *progname, int argc,
                             char *argv[]) {
